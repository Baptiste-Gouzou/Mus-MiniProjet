...
class GrandTest {
  ...
  void devrait_faire_gagner_le_joueur_esku_s_il_a_la_plus_grande_carte() {
    Joueur joueurEsku = unJoueurAvec(main(Carte.DEUX_PIECE, Carte.CINQ_PIECE, Carte.ROI_BATON, Carte.SIX_COUPE));
  ...
  void devrait_faire_gagner_le_joueur_zaku_s_il_a_la_plus_grande_carte() {
    Joueur joueurEsku = unJoueurAvec(main(Carte.DEUX_PIECE, Carte.CINQ_PIECE, Carte.AS_BATON, Carte.SIX_COUPE));
    Joueur joueur2 = unJoueurAvec(main(Carte.DEUX_PIECE, Carte.CINQ_PIECE, Carte.SEPT_BATON, Carte.SIX_COUPE));
    Joueur joueur3 = unJoueurAvec(main(Carte.DEUX_BATON, Carte.TROIS_PIECE, Carte.CAVALIER_BATON, Carte.SIX_BATON));
  ...
  void devrait_faire_gagner_le_joueur_esku_si_les_deux_mains_sont_egales() {
    Joueur joueurEsku = unJoueurAvec(main(Carte.DEUX_PIECE, Carte.CINQ_PIECE, Carte.CAVALIER_BATON, Carte.SIX_COUPE));
    Joueur joueur2 = unJoueurAvec(main(Carte.DEUX_PIECE, Carte.CINQ_PIECE, Carte.CAVALIER_BATON, Carte.SIX_COUPE));
    Joueur joueur3 = unJoueurAvec(main(Carte.DEUX_BATON, Carte.CINQ_PIECE, Carte.CAVALIER_BATON, Carte.SIX_BATON));
